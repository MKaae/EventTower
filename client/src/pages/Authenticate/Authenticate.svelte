...
<div class="container d-flex justify-content-center align-items-center vh-100">
  ...
  >
    ...
    <div class="text-center">
      <p>
        ...
        <button id="login-form-btn" on:click={() => (showSignUp = !showSignUp)} class="btn btn-primary">
          Login here
        </button>
      </p>
    </div>
  ...
  >
    ...
    <div class="text-center">
      <p>
        Need an account?
        <button id="signup-form-btn" on:click={() => (showSignUp = !showSignUp)} class="btn btn-primary">
          Sign up here
        </button>
      </p>
    </div>
